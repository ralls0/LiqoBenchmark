      ...
      case $FVALUE in
        kind | KIND)
          ...
          then 
            ...
            kind create cluster --name $CLUSTER_NAME --kubeconfig $HOME/.kube/liqo_${CLUSTER_NAME}_config
            echo "alias liqo_${CLUSTER_NAME}_config=\"export KUBECONFIG=$HOME/.kube/liqo_${CLUSTER_NAME}_config\""
